...
public class AddServiceRequest  extends com.broadhop.unifiedapi.soap.types.BaseRequestNetworkIdType  implements java.io.Serializable {
...
//		return "AddServiceRequest [service=" + Arrays.toString(service) + ", balance=" + Arrays.toString(balance)
//				+ ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + ", getService()="
//				+ Arrays.toString(getService()) + ", getBalance()=" + Arrays.toString(getBalance()) + ", hashCode()="
...
//	}
    ...
    @Override
   	public String toString() {
   		return "AddServiceRequest [service=" + Arrays.toString(service) + ", getService()="
   				+ Arrays.toString(getService()) + ", getNetworkId()=" + getNetworkId() + "]";
   	}

	/**
     * Gets the service value for this AddServiceRequest.
     * 
     * @return service
     */
    ...
    /**
     * Sets the service value for this AddServiceRequest.
     * 
     * @param service
     */
    ...
    /**
     * Gets the balance value for this AddServiceRequest.
     * 
     * @return balance
     */
    ...
    /**
     * Sets the balance value for this AddServiceRequest.
     * 
     * @param balance
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddServiceRequest)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddServiceRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://broadhop.com/unifiedapi/soap/types", ">AddServiceRequest"));
