...
public class CreateVoucherRequest  extends com.broadhop.unifiedapi.soap.types.BaseRequestAuditType  implements java.io.Serializable {
    ...
    /**
     * Gets the voucher value for this CreateVoucherRequest.
     * 
     * @return voucher
     */
    ...
    /**
     * Sets the voucher value for this CreateVoucherRequest.
     * 
     * @param voucher
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateVoucherRequest)) return false;
        CreateVoucherRequest other = (CreateVoucherRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateVoucherRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://broadhop.com/unifiedapi/soap/types", ">CreateVoucherRequest"));
