...
public class GetSubscriberResponse  extends com.broadhop.unifiedapi.soap.types.ResponseType  implements java.io.Serializable {
	...
	public String toString() {
		return "GetSubscriberResponse [getErrorCode()=" + getErrorCode() + ", getErrorMessage()=" + getErrorMessage() + "]";
	}

	/**
     * Gets the subscriber value for this GetSubscriberResponse.
     * 
     * @return subscriber
     */
    ...
    /**
     * Sets the subscriber value for this GetSubscriberResponse.
     * 
     * @param subscriber
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://broadhop.com/unifiedapi/soap/types", ">GetSubscriberResponse"));
